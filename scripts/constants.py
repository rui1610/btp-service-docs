...
INDEX_OUTPUT_DOCS_MD = Path(FOLDER_OUTPUT_DOCS, "index.md").resolve()
FOLDER_OUTPUT_DOCS_MD = Path(FOLDER_OUTPUT_DOCS, "services").resolve()

TEMPLATE_DEVELOPERS_MD = Path(FOLDER_TEMPLATES, "SERVICE-DETAILS.MD").resolve()
TEMPLATE_DEVELOPERS_MD_INDEX = Path(FOLDER_TEMPLATES, "SERVICE-OVERVIEW.MD").resolve()
